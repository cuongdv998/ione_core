...
/// <summary>
/// DTO for SystemEventNotify with AppChannel Type information
/// </summary>
public class SystemEventNotifyWithChannelTypeDto : FullAuditedEntityDto<Guid>
{
    ...
    [Display(Name = "SystemEventNotify:ChannelType")]
