...
public class CreateResPartnerDto
{
    ...
    [StringLength(25, ErrorMessage = "Partner:ResPartner:CodeMaxLength")]
    [RegularExpression(@"^[A-Z0-9_]+$", ErrorMessage = "Partner:ResPartner:CodeInvalid")]
    ...
    public ResPartnerStatus Status { get; set; } = ResPartnerStatus.Active;
    ...
    // Agreements (optional)
    public List<CreateResPartnerAgreementDto>? Agreements { get; set; }
}
