...
public class IdentityUserAppService : IdentityAppServiceBase, IIdentityUserAppService
{
    ...
    public virtual async Task<IdentityUserDto> CreateAsync(IdentityUserCreateDto input)
    {
        ...
        // Same as self-registration / external login: ensure roles marked IsDefault are assigned.
        // Admin UI may send an empty roleNames array; without this, new users would have no roles.
