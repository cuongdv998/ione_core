...
public class CreatePolicyVersionDto
{
    ...
    [Required(ErrorMessage = "PolicyVersion:PolicyIdRequired")]
    [Display(Name = "PolicyVersion:PolicyId")]
    public Guid PolicyId { get; set; }

    [Required(ErrorMessage = "PolicyVersion:TypeRequired")]
    [StringLength(15, ErrorMessage = "PolicyVersion:TypeMaxLength")]
