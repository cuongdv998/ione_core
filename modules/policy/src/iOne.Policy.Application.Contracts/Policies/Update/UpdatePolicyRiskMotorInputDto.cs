...
public class UpdatePolicyRiskMotorInputDto
{
    // policy_risk_motor.id (nullable: null means create new row)
    public Guid? Id { get; set; }

    [Display(Name = "PolicyRiskMotor:RiskObjectValue")]
    public decimal? RiskObjectValue { get; set; }

    [StringLength(15, ErrorMessage = "PolicyRiskMotor:MotorClassCodeMaxLength")]
    ...
    [StringLength(50, ErrorMessage = "PolicyRiskMotor:CarUsageMaxLength")]
    ...
    [StringLength(50, ErrorMessage = "PolicyRiskMotor:CarVinMaxLength")]
    [Display(Name = "PolicyRiskMotor:CarVin")]
    public string? CarVin { get; set; }

    [StringLength(50, ErrorMessage = "PolicyRiskMotor:CarEngineNumberMaxLength")]
    ...
    [StringLength(50, ErrorMessage = "PolicyRiskMotor:CarColorMaxLength")]
