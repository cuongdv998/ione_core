...
public class UpdatePolicyCoverageInputDto
{
    // policy_coverage.id (nullable: null means create new row)
    ...
    public List<UpdatePolicyCoverageLevelInputDto>? CoverageLevels { get; set; }
}
