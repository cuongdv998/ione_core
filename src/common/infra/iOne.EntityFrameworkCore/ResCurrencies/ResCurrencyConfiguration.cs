...
namespace iOne.EntityFrameworkCore.ResCurrencies;

public class ResCurrencyConfiguration : IEntityTypeConfiguration<ResCurrency>
{
    public void Configure(EntityTypeBuilder<ResCurrency> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_currency", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResCurrencyStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
