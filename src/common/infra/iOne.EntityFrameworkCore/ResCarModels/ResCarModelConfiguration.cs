...
namespace iOne.EntityFrameworkCore.ResCarModels;

public class ResCarModelConfiguration : IEntityTypeConfiguration<ResCarModel>
{
    public void Configure(EntityTypeBuilder<ResCarModel> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_car_model", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResCarBrandStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
