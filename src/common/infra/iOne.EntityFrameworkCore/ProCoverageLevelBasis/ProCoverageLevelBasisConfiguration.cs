...
public class ProCoverageLevelBasisConfiguration : IEntityTypeConfiguration<ProCoverageLevelBasisEntity>
{
    public void Configure(EntityTypeBuilder<ProCoverageLevelBasisEntity> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("pro_coverage_level_basis", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ProCoverageLevelBasisStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
