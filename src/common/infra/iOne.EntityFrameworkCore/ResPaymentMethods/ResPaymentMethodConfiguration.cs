...
namespace iOne.EntityFrameworkCore.ResPaymentMethods;

public class ResPaymentMethodConfiguration : IEntityTypeConfiguration<ResPaymentMethod>
{
    public void Configure(EntityTypeBuilder<ResPaymentMethod> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_payment_method", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResPaymentMethodStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(10)
            .IsRequired()
