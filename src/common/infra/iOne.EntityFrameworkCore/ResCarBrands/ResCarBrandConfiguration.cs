...
public class ResCarBrandConfiguration : IEntityTypeConfiguration<ResCarBrand>
{
    public void Configure(EntityTypeBuilder<ResCarBrand> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_car_brand", t =>
        {
