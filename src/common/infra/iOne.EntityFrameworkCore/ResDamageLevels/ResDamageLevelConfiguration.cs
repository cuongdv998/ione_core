...
namespace iOne.EntityFrameworkCore.ResDamageLevels;

public class ResDamageLevelConfiguration : IEntityTypeConfiguration<ResDamageLevel>
{
    public void Configure(EntityTypeBuilder<ResDamageLevel> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_damage_level", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResDamageLevelStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
