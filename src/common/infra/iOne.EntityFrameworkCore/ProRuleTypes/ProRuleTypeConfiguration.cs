...
namespace iOne.EntityFrameworkCore.ProRuleTypes;

public class ProRuleTypeConfiguration : IEntityTypeConfiguration<ProRuleType>
{
    public void Configure(EntityTypeBuilder<ProRuleType> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("pro_rule_type", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ProRuleTypeStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
