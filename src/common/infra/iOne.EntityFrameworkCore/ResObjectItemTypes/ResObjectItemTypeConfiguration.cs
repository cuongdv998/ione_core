...
public class ResObjectItemTypeConfiguration : IEntityTypeConfiguration<ResObjectItemType>
{
    public void Configure(EntityTypeBuilder<ResObjectItemType> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_object_item_type", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResObjectItemTypeStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
