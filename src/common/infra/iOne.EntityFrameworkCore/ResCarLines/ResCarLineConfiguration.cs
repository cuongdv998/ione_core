...
namespace iOne.EntityFrameworkCore.ResCarLines;

public class ResCarLineConfiguration : IEntityTypeConfiguration<ResCarLine>
{
    public void Configure(EntityTypeBuilder<ResCarLine> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_car_line", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResCarLineStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
