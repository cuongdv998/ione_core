...
namespace iOne.EntityFrameworkCore.ResMotorClasses;

public class ResMotorClassConfiguration : IEntityTypeConfiguration<ResMotorClass>
{
    public void Configure(EntityTypeBuilder<ResMotorClass> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_motor_class", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResMotorClassStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
