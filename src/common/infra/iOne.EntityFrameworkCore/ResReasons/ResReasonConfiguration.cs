...
namespace iOne.EntityFrameworkCore.ResReasons;

public class ResReasonConfiguration : IEntityTypeConfiguration<ResReason>
{
    public void Configure(EntityTypeBuilder<ResReason> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_reason", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResReasonGroupStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
        ...
        builder.HasOne(x => x.ReasonGroup)
