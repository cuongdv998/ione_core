...
public class ResIncidentLevelConfiguration : IEntityTypeConfiguration<ResIncidentLevel>
{
    public void Configure(EntityTypeBuilder<ResIncidentLevel> builder)
    {
        builder.ToTable("res_incident_level", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResIncidentLevelStatus>(v, true)
            )
            .HasMaxLength(10)
            .IsRequired()
