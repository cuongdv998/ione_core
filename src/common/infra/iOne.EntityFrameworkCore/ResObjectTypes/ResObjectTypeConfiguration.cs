...
namespace iOne.EntityFrameworkCore.ResObjectTypes;

public class ResObjectTypeConfiguration : IEntityTypeConfiguration<ResObjectType>
{
    public void Configure(EntityTypeBuilder<ResObjectType> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_object_type", t =>
        {
        ...
        builder.Property(x => x.ObjectGroup)
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ResObjectTypeStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
