...
public class ResReasonGroupConfiguration : IEntityTypeConfiguration<ResReasonGroup>
{
    public void Configure(EntityTypeBuilder<ResReasonGroup> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("res_reason_group", t =>
        {
