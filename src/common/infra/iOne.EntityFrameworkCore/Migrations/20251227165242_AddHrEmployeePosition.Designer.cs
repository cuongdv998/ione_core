...
namespace iOne.Migrations
{
    ...
    [Migration("20251227165242_AddHrEmployeePosition")]
    partial class AddHrEmployeePosition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("iOne.HrDepartmentTypes.HrDepartmentType", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "IX_HrDepartmentType_Code")
                        .IsUnique();

                    b.ToTable("HrDepartmentType", null, t =>
                        {
            ...
            modelBuilder.Entity("iOne.HrEmployeeLevels.HrEmployeeLevel", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "IX_HrEmployeeLevel_Code")
                        .IsUnique();

                    b.ToTable("HrEmployeeLevel", null, t =>
                        {
            ...
            modelBuilder.Entity("iOne.HrEmployeePositions.HrEmployeePosition", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "IX_HrEmployeePosition_Code")
                        .IsUnique();

                    b.ToTable("HrEmployeePosition", null, t =>
                        {
            ...
            modelBuilder.Entity("iOne.HrEmployeeRoles.HrEmployeeRole", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "IX_HrEmployeeRole_Code")
                        .IsUnique();

                    b.ToTable("HrEmployeeRole", null, t =>
                        {
