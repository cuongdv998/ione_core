...
namespace iOne.Migrations
{
    ...
    [Migration("20260126135657_AddTaleClaim")]
    partial class AddTaleClaim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iOne.ClaimIncidentRiskMotors.ClaimIncidentRiskMotor", b =>
                {
                    ...
                    b.Property<DateTime?>("DriverLicenseEffectDate")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("DRIVERLICENSEEFFECTDATE")
                    ...
                    b.Property<string>("DriverLicenseLevel")
                        ...
                        .HasColumnName("DRIVERLICENSELEVEL")
                    ...
                    b.Property<Guid?>("IncidentObjectId")
                        .HasColumnType("uuid")
                        .HasColumnName("INCIDENTOBJECTID")
                    ...
                    b.ToTable("CLAIMINCIDENTRISKMOTOR", null, t =>
                        {
            ...
            modelBuilder.Entity("iOne.ClaimIncidents.ClaimIncident", b =>
                {
                    ...
                    b.Property<Guid?>("AssessmentPartnerId")
                        .HasColumnType("uuid")
                        .HasColumnName("ASSESSMENTPARTNERID")
                    ...
                    b.Property<string>("IncidentFullAddress")
                        .HasMaxLength(250)
                        .HasColumnType("character varying(250)")
                        .HasColumnName("INCIDENTFULLADDRESS")
                    ...
                    b.Property<string>("OnLocation")
                        ...
                        .HasColumnName("ONLOCATION")
                        .HasComment("Còn ở hiện trường hay không: Y (có), N (không)");

                    b.HasKey("Id");

                    b.HasIndex("AssessmentPartnerId");

                    b.HasIndex("IncidentLevelId");

                    b.HasIndex("IncidentProvinceId");
                    ...
                    b.ToTable("CLAIMINCIDENT", null, t =>
                        {
            ...
            modelBuilder.Entity("iOne.Claims.Claim", b =>
                {
                    ...
                    b.Property<string>("ContactInRelationship")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("CONTACTINRELATIONSHIP")
                    ...
                    b.Property<string>("InsurerIncidentCode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("INSURERINCIDENTCODE")
                    ...
                    b.Property<string>("ProcessClaimType")
                        ...
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)")
                        .HasColumnName("PROCESSCLAIMTYPE")
                    ...
                    b.HasIndex(new[] { "Code" }, "ix_claim_code")
                        .IsUnique();
            ...
            modelBuilder.Entity("iOne.ResClaimTypes.ResClaimType", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "ix_res_claim_type_code")
                        .IsUnique();
            ...
            modelBuilder.Entity("iOne.ResIncidentCauses.ResIncidentCause", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "ix_res_incident_cause_code")
                        .IsUnique();

                    b.ToTable("RESINCIDENTCAUSE", null, t =>
                        {
            ...
            modelBuilder.Entity("iOne.ResIncidentLevels.ResIncidentLevel", b =>
                {
                    ...
                    b.HasIndex(new[] { "Code" }, "ix_res_incident_level_code")
                        .IsUnique();

                    b.ToTable("RESINCIDENTLEVEL", null, t =>
                        {
                            t.HasComment("Định nghĩa mức độ tổn thất");
                        });
                });
            ...
            modelBuilder.Entity("iOne.ClaimIncidents.ClaimIncident", b =>
                {
                    b.HasOne("iOne.ResPartners.ResPartner", "AssessmentPartner")
                        .WithMany()
                        .HasForeignKey("AssessmentPartnerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("iOne.ResIncidentCauses.ResIncidentCause", "IncidentCause")
                        .WithMany()
                        .HasForeignKey("IncidentCauseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_CLAIMINC_REFERENCE_RESINCID_CAUSE");

                    b.HasOne("iOne.Claims.Claim", "Incident")
                        .WithMany()
                    ...
                    b.HasOne("iOne.ResIncidentLevels.ResIncidentLevel", "IncidentLevel")
                        .WithMany()
                        .HasForeignKey("IncidentLevelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_CLAIMINC_REFERENCE_RESINCID_LEVEL");

                    b.HasOne("iOne.ResProvinces.ResProvince", "IncidentProvince")
                        .WithMany()
                        .HasForeignKey("IncidentProvinceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("iOne.ResWards.ResWard", "IncidentWard")
                        .WithMany()
                    ...
                    b.Navigation("AssessmentPartner");

                    b.Navigation("Incident");

                    b.Navigation("IncidentCause");

                    b.Navigation("IncidentLevel");

                    b.Navigation("IncidentProvince");
