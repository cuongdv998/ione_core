...
{
    /// <inheritdoc />
    public partial class AddTableResModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_res_car_model", x => x.id);
                    table.ForeignKey(
                        name: "FK_res_car_model_res_car_brand_car_brand_id",
                        column: x => x.car_brand_id,
                        principalTable: "res_car_brand",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                },
                comment: "Định nghĩa dòng xe (Vios, ...)");

            migrationBuilder.CreateIndex(
                name: "IX_res_car_model_car_brand_id",
                table: "res_car_model",
                column: "car_brand_id");
