...
{
    /// <inheritdoc />
    public partial class AddTableMotorClass : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "res_motor_class",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_res_motor_class", x => x.id);
                },
                comment: "Phân loại xe theo động cơ (Động cơ đốt trong, Xe điện ...)");
