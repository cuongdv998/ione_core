...
{
    /// <inheritdoc />
    public partial class AddTableProCoverageLevelType : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "pro_coverage_level_type",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_pro_coverage_level_type", x => x.id);
                },
            ...
            migrationBuilder.Sql($@"
                INSERT INTO pro_coverage_level_type (id, code, name, description, status, extra_properties, concurrency_stamp, creation_time, creator_id, is_deleted)
                VALUES 
                ('{typeOneId}', 'TYPEONE', 'mức miễn thường', NULL, 'active', '{{}}', '{concurrencyStamp1}', CURRENT_TIMESTAMP, '{creatorId}', false),
                ('{typeTwoId}', 'TYPETWO', 'mức đồng chi trả', NULL, 'active', '{{}}', '{concurrencyStamp2}', CURRENT_TIMESTAMP, '{creatorId}', false);
            ");
        }
