...
{
    /// <inheritdoc />
    public partial class ResObjectItemType : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "res_object_item_type",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_res_object_item_type", x => x.id);
                },
                comment: "Object Item Type Classification");
