...
namespace iOne.Migrations
{
    ...
    [Migration("20260226212344_ResTaskCategory_AddCodeLength")]
    partial class ResTaskCategory_AddCodeLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iOne.ClaimDocuments.ClaimDocument", b =>
                {
                    ...
                    b.Property<Guid?>("AdjustAtLocationId1")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ClaimFolderId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AdjustAtLocationId1");

                    b.HasIndex("ClaimFolderId");

                    b.HasIndex("ClaimFolderId1");
            ...
            modelBuilder.Entity("iOne.ClaimFolderItemPlans.ClaimFolderItemPlan", b =>
                {
                    ...
                    b.Property<Guid?>("ClaimFolderItemId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClaimFolderItemId");

                    b.HasIndex("ClaimFolderItemId1");

                    b.HasIndex("ClaimPlanId");

                    b.HasIndex("ClaimPlanId1");
            ...
            modelBuilder.Entity("iOne.ClaimFolderItems.ClaimFolderItem", b =>
                {
                    ...
                    b.Property<Guid?>("ClaimFolderExposureId1")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ClaimFolderIncidentObjectId1")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DemageLevelId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClaimFolderExposureId1");
                    ...
                    b.HasIndex("ClaimFolderIncidentObjectId1");

                    b.HasIndex("DemageLevelId");

                    b.HasIndex("DemageLevelId1");
            ...
            modelBuilder.Entity("iOne.ClaimFolders.ClaimFolder", b =>
                {
                    ...
                    b.Property<Guid?>("CloseEmployeeId1")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("OpenEmployeeId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CloseEmployeeId1");

                    b.HasIndex("InsurerId");

                    b.HasIndex("InsurerId1");

                    b.HasIndex("OpenEmployeeId");

                    b.HasIndex("OpenEmployeeId1");
            ...
            modelBuilder.Entity("iOne.ProProductPlanDefinitions.ProProductPlanDefinition", b =>
                {
                    ...
                    b.HasIndex(new[] { "PlanCode" }, "ix_pro_product_plan_definition_plan_code")
                        .IsUnique();
            ...
            modelBuilder.Entity("iOne.ClaimAdjustAtLocations.ClaimAdjustAtLocation", b =>
                {
                    b.HasOne("iOne.HrEmployees.HrEmployee", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.HrEmployees.HrEmployee", "Adjustor")
                        .WithMany()
                        .HasForeignKey("AdjustorId1");

                    b.HasOne("iOne.Claims.Claim", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.ResPartners.ResPartner", null)
                        .WithMany()
            ...
            modelBuilder.Entity("iOne.ClaimDocuments.ClaimDocument", b =>
                {
                    b.HasOne("iOne.ClaimAdjustAtLocations.ClaimAdjustAtLocation", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.ClaimAdjustAtLocations.ClaimAdjustAtLocation", "AdjustAtLocation")
                        .WithMany()
                        .HasForeignKey("AdjustAtLocationId1");
            ...
            modelBuilder.Entity("iOne.ClaimFolderIncidentObjects.ClaimFolderIncidentObject", b =>
                {
                    ...
                    b.HasOne("iOne.ResObjectTypes.ResObjectType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("iOne.ClaimFolderItemPlans.ClaimFolderItemPlan", b =>
                {
                    ...
                    b.HasOne("iOne.ClaimFolderItems.ClaimFolderItem", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.ClaimFolderItems.ClaimFolderItem", "ClaimFolderItem")
                        .WithMany()
                        .HasForeignKey("ClaimFolderItemId1");

                    b.HasOne("iOne.ResClaimPlans.ResClaimPlan", null)
                        .WithMany()
            ...
            modelBuilder.Entity("iOne.ClaimFolderItems.ClaimFolderItem", b =>
                {
                    b.HasOne("iOne.ClaimFolderExposures.ClaimFolderExposure", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.ClaimFolderExposures.ClaimFolderExposure", "ClaimFolderExposure")
                        .WithMany()
                        .HasForeignKey("ClaimFolderExposureId1");
                    ...
                    b.HasOne("iOne.ClaimFolderIncidentObjects.ClaimFolderIncidentObject", "ClaimFolderIncidentObject")
                        .WithMany()
                        .HasForeignKey("ClaimFolderIncidentObjectId1");

                    b.HasOne("iOne.ResDamageLevels.ResDamageLevel", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.ResDamageLevels.ResDamageLevel", "DemageLevel")
                        .WithMany()
                        .HasForeignKey("DemageLevelId1");

                    b.HasOne("iOne.ResObjectTypeItems.ResObjectTypeItem", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.ResRisks.ResRisk", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.ResUoms.ResUom", null)
                        .WithMany()
                        .HasForeignKey("UomId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("iOne.ClaimFolders.ClaimFolder", b =>
                {
                    ...
                    b.HasOne("iOne.ResClaimTypes.ResClaimType", null)
                        .WithMany()
                    ...
                    b.HasOne("iOne.HrEmployees.HrEmployee", "CloseEmployee")
                        .WithMany()
                        .HasForeignKey("CloseEmployeeId1");
            ...
            modelBuilder.Entity("iOne.ClaimSlas.ClaimSla", b =>
                {
                    b.HasOne("iOne.ResClaimStages.ResClaimStage", null)
                        .WithMany()
