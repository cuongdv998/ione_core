...
{
    /// <inheritdoc />
    public partial class ProCoverageGroup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "pro_coverage_group",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_pro_coverage_group", x => x.id);
                },
                comment: "Bảng định nghĩa nhóm phạm vi");
