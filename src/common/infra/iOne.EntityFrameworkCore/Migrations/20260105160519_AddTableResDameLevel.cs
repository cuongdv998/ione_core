...
{
    /// <inheritdoc />
    public partial class AddTableResDameLevel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "res_damage_level",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_res_damage_level", x => x.id);
                    table.ForeignKey(
                        name: "FK_res_damage_level_res_object_type_object_type_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_res_damage_level_object_type_id",
                table: "res_damage_level",
