...
public class ProCoverageLevelTypeConfiguration : IEntityTypeConfiguration<ProCoverageLevelType>
{
    public void Configure(EntityTypeBuilder<ProCoverageLevelType> builder)
    {
        // ✅ Table name: snake_case (PostgreSQL convention)
        builder.ToTable("pro_coverage_level_type", t =>
        {
        ...
        builder.Property(x => x.Status)
            ...
            .HasConversion<string>(
                ...
                v => Enum.Parse<ProCoverageLevelTypeStatus>(v, true) // Parse "active" → Active, "deactive" → Deactive
            )
            .HasMaxLength(15)
            .IsRequired()
